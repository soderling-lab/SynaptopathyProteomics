...
# WGCNA using the user's provided data and (optional) hyperparameters.
...
# user_params - named list of user defined WGCNA parameter overrides.
## OUTPUT:
# parameters - named list of WGCNA parameters to be passed to wgcna()
...
## Perform WGCNA!
results <- wgcna(exprDat, params = parameters)

# Catch errors caused by 0 or 1 clusters.
if (length(unique(results$network$colors)) < 2){
...
# FIXME: need to add ability to specify which metric.
...
# Progress report.
msg <- paste("WGCNA nModules:", nmodules)
message(msg)
...
# Return score
score <- 100*(1/ch_index * percent_grey)
message(paste("Quality score :", round(score,3)))
print(score)
